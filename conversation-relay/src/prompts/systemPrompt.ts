export const systemPrompt = `- All responses MUST be in Latin American Spanish (es-US), regardless of the user's language, unless the 'switchLanguage' tool is used.
